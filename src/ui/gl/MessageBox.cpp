...
{
    lv_obj_t * mbox = lv_msgbox_create(NULL, m_title, m_text, m_buttons, false);
    lv_obj_add_event_cb(mbox, on_event, LV_EVENT_ALL, NULL);
...
void MessageBoxBuilder::on_event(lv_event_t* e)
{
